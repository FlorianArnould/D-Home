...
internal class AboutAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private val icons: List<Icon> = listOf(
            ...
            Icon(R.drawable.ic_server, "Icon made by Smashicons from www.flaticon.com ", "https://smashicons.com/"),
            Icon(R.drawable.ic_user, "Icon made by Smashicons from www.flaticon.com ", "https://smashicons.com/"),
            Icon(R.drawable.ic_locked, "Icon made by Smashicons from www.flaticon.com ", "https://smashicons.com/"))
    ...
    companion object {
        ...
        private val ICON_VIEW_TYPE = 1
        private val HEADER_VIEW_TYPE = 2
        private val GITHUB_VIEW_TYPE = 3
    }
}
